...
const char* ssid = "Xiaomi 15 Pro"; //Your WiFi Name
const char* password = "xiaomi15pro"; //Your WiFi Password
...
void Camera_init(){
  ...
  config.jpeg_quality = 10; //chanege the quality according to your needs
  config.fb_count = 1;
